...
const InputField = ({ name, placeholder, type = 'text', value, onChange ,color }) => {
    ...
    return (
        <div className='relative'>
            <input
                ...
                className={`border border-[#D3D3D3] lg:w-[225px] xl:w-[346px]
                         h-[50px] p-[18px] rounded-[10px] text-[18px]`}
