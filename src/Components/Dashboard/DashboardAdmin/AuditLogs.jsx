...
const AuditLogs = () => {
    ...
    return (
        <div>
            <section className='flex flex-col gap-[8px] lg:gap-[24px] leading-6'>
            ...
            <section className='mt-[25px] lg:mt-[40px] flex flex-col gap-[12px]'>
                {logs.slice(0, visible).map((item, index) => (
                    <div key={index} className='w-full h-[80px] border border-[#D3D3D3] rounded-[6px] px-[16px] flex items-center gap-[20px] '>
                        ...
                        <h1 className='text-[16px] lg:text-[20px] font-bold'>{item.name}</h1>
                ...
                <div className='flex items-center justify-between mt-6'>
                    ...
                    {visible < logs.length &&
                        <h2
                            ...
                            className="text-[20px] lg:text-[24px] font-bold underline decoration-solid decoration-2 underline-offset-[4px] cursor-pointer ">
                            See more
                        </h2>
                    }
                </div>
