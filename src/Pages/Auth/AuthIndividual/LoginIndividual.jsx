...
import logo from '../../../assets/Iconindividual/Logoindividual.svg'
...
const LoginIndividual = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token && role === "ic") {
        ...
        setError('Unauthorized access. Only IC role can log in.');
      }
    } catch (error) {
  ...
  return (
    <div>
      <LoginMobileBank bg='bg-[#EE7A32]' logo={logoHeader} />
              ...
              <div className='flex flex-col gap-[12px]'>
                <div className='flex justify-between lg:w-[470px] xl:w-[709px]'>
                  <div className='flex items-center gap-2'>
                    <CheckBox color={'#EE7A32'} bg={"#D3D3D3"} title={title} />
                  </div>
