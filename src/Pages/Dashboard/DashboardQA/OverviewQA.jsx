...
import PerferMetQA from '../../../Components/Dashboard/DashboardQA/PerferMetQA'
    ...
    return (
        <div>
            ...
            <div className='min-h-screen w-full xl:w-[850px] 2xl:w-[1205px] pt-[50px] lg:pt-[97px] mb-10 
                ...
                <PerferMetQA className='flex flex-col gap-[12px] lg:gap-[24px]  pt-[40px] lg:pt-[60px] ' />

                {/* Wrapping chart-related components in a flex container */}
                <div className=' py-[40px] lg:py-[60px]  flex flex-col gap-[20px] lg:gap-[60px]'>

                    <div className='leading-5 flex flex-col lg:gap-[20px]  '>
                        <h1 className='text-[18px] lg:text-[28px] font-bold '>Performance Trends</h1>
